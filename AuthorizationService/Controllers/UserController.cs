...
using AuthorizationService.BLL.Extensions.Authorization.Attributes;
...
public class UserController : ControllerBase
{
    ...
    {
        var response = _userService.Authenticate(model, ipAddress()).Result;
    ...
    public ActionResult<AuthenticateResponse> RefreshToken()
    {
        ...
        var response = _userService.RefreshToken(refreshToken, ipAddress()).Result;
        SetTokenCookie(response.RefreshToken);
        return Ok(response);
    }
